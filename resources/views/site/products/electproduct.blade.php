@extends('layouts.app_productdetails')
@section('content')
                                ...
                                <div class="product-details-large tab-content">
                                    <div class="tab-pane active show fade" id="pro-details1" role="tabpanel">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('img/product-details/bl1.jpg')}}">
                                                <img src="{{asset('img/product-details/l1.jpg')}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pro-details2" role="tabpanel">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('img/product-details/bl2.jpg')}}">
                                                <img src="{{asset('img/product-details/l2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pro-details3" role="tabpanel">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('img/product-details/bl3.jpg')}}">
                                                <img src="{{asset('img/product-details/l3.jpg')}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pro-details4" role="tabpanel">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="{{asset('img/product-details/bl4.jpg')}}">
                                                <img src="{{asset('img/product-details/l4.jpg')}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
