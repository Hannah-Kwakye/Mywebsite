        ...
        <div class="single-slider-4 slider-height-4 bg-img" style="background-image: url({{asset('img/slider/6.jpg') }}">
            <div class="container">
                <div class="slider-content-4 fadeinup-animated">
                    ...
                    <a class="electro-slider-btn btn-hover animated" href="{{ route('productdetails.index') }}">buy now</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="banner-wrapper-4 mb-30">
                    <a href="{{ route('electshopgrid') }}"><img src="{{asset('img/banner/20.jpg')}}" alt="">
            ...
            <div class="col-lg-4">
                <div class="banner-wrapper-4 mb-30">
                    <a href="{{ route('electshopgrid') }}"><img src="{{asset('img/banner/21.jpg')}}" alt="">
            ...
            <div class="col-lg-4">
                <div class="banner-wrapper-4 mb-30">
                    <a href="{{ route('electshopgrid') }}"><img src="{{asset('img/banner/22.jpg')}}" alt="">
        ...
        <div class="row">
                ...
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        ...
                        <a href="{{ route('productdetails.index') }}">
                            <img src="{{asset('img/product/electro/22.jpg')}}" alt="">
                        </a>
                    ...
                    <div class="product-content-electro2 text-center">
                        <h3><a href="{{ route('productdetails.index') }}"> Demo TV 32GB</a></h3>
                        <span>Black</span>
                        <h5>$49.99</h5>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="#">
                            <img src="{{asset('img/product/electro/23.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
                    ...
                    <div class="product-content-electro2 text-center">
                        <h3><a href="{{ route('productdetails.index') }}">Pebble Time</a></h3>
                        <span>Black</span>
                        <h5>$49.99</h5>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="{{ route('productdetails.index') }}">
                            <img src="{{asset('img/product/electro/24.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
                    ...
                    {{-- <div class="product-content-electro2 text-center">
                        <h3><a href="{{ route('productdetails.index') }}">Zendure 4-Port USB</a></h3>
                        <span>Black</span>
                        <h5>$49.99</h5>
                    </div> --}}
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="#">
                            <img src="{{asset('img/product/electro/25.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="#">
                            <img src="{{asset('img/product/electro/26.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="#">
                            <img src="{{asset('img/product/electro/27.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="#">
                            <img src="{{asset('img/product/electro/28.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="product-wrapper mb-30">
                    <div class="product-img-3">
                        <a href="#">
                            <img src="{{asset('img/product/electro/29.jpg')}}" alt="">
                        </a>
                        <div class="hanicraft-action-position">
                            <div class="hanicraft-action">
                                <a class="action-cart" title="Add To Cart" href="#">
...
<div class="banner-area wrapper-padding pt-15 pb-95 gray-bg-7">
    <div class="container">
        <div class="electro-fexible-banner bg-img" style="background-image: url({{asset('img/banner/23.jpg)')}}">
            ...
            <div class="fexible-content fexible-content-2 ">
                ...
                <a class="btn-hover flexible-btn" href="{{ route('productdetails.index') }}">Buy Now</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="best-selling-left">
                    <div class="product-wrapper">
                        <div class="product-img-4">
                            <a href="#"><img src="{{asset('img/product/electro/9.jpg')}}" alt=""></a>
                        ...
                        <div class="product-content-5 text-center">
                            ...
                            <h4><a href="{{ route('productdetails.index') }}">desktop C27F551</a></h4>
                            <span>Headphone</span>
                            <h5>$133.00</h5>
                        </div>
                    </div>
                        ...
                        <div class="coustom-row-3">
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('img/product/electro/10.jpg')}}" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="{{ route('productdetails.index') }}">Play Station</a></h4>
                                        <h5>$145.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('img/product/electro/11.jpg')}}" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="{{ route('productdetails.index') }}">Joy Stick</a></h4>
                                        <h5>$145.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('img/product/electro/12.jpg')}}" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="{{ route('productdetails.index') }}">Awesome Tab</a></h4>
                                        <h5>$145.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('img/product/electro/13.jpg')}}" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="{{ route('productdetails.index') }}">Trimmer C27F401</a></h4>
                                        <h5>$145.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('img/product/electro/14.jpg')}}" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
                                    ...
                                    <div class="product-content-6">
                                        ...
                                        <h4><a href="{{ route('productdetails.index') }}">Timer C27F500</a></h4>
                                        <h5>$145.00</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="custom-col-style-3 custom-col-3">
                                <div class="product-wrapper mb-6">
                                    <div class="product-img-4">
                                        <a href="#">
                                            <img src="{{asset('img/product/electro/15.jpg')}}" alt="">
                                        </a>
                                        <div class="product-action-right">
                                            <a class="animate-top" title="Add To Cart" href="#">
                                                <i class="pe-7s-cart"></i>
...
<div class="androit-banner-wrapper wrapper-padding pt-100 pb-175">
    <div class="container-fluid">
        ...
        <div class="androit-banner-img bg-img" style="background-image: url({{asset('img/banner/36.jpg') }}")>
            <div class="androit-banner-content">
                <h3>Xolo Fast T2 Smartphone, Android <br>7.0 Unlocked.</h3>
                <a href="{{ route('productdetails.index') }}">Buy Now →</a>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-xl-4">
                <div class="product-wrapper product-wrapper-border mb-30">
                    <div class="product-img-5">
                        <a href="#">
                            <img src="{{asset('img/product/electro/16.jpg')}}" alt="">
                        </a>
                    </div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="product-wrapper product-wrapper-border mb-30">
                    <div class="product-img-5">
                        <a href="#">
                            <img src="{{asset('img/product/electro/17.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="product-content-7">
                        <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="product-wrapper product-wrapper-border mb-30">
                    <div class="product-img-5">
                        <a href="#">
                            <img src="{{asset('img/product/electro/21.jpg')}}" alt="">
                        </a>
                    </div>
                    <div class="product-content-7">
                        <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
    ...
    <div class="container-fluid">
        <div class="brand-logo-active2 owl-carousel">
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/7.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/8.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/9.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/10.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/11.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/12.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/13.png')}}" alt="">
            </div>
            <div class="single-brand">
                <img src="{{asset('img/brand-logo/7.png')}}" alt="">
            </div>
